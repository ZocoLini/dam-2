...
public class EmpregadoProxectoId implements java.io.Serializable {
    ...
    public boolean equals(Object other) {
        ...
        return ((this.getNssempregado() == castOther.getNssempregado()) ||
                (this.getNssempregado() != null && castOther.getNssempregado() != null && this.getNssempregado().equals(castOther.getNssempregado())))
