...
public class Sara
{
    ...
    public synchronized void comprarProducto(Producto producto, Cliente cliente)
    {
        ...
        System.out.printf("%s - %s - %d\n", producto.toString(), cliente.getClienteName(), productosAunNoComprados.get(producto));

        if (!finalDeExistencias && estanTodosLosProductosVendidos())
        {
    ...
    private boolean estanTodosLosProductosVendidos()
    {
